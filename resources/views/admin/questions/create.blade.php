    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('confirm_email') ? 'is-invalid' : '' }}" type="text" name="confirm_email" id="confirm_email" value="{{ old('confirm_email', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ask_question') ? 'is-invalid' : '' }}" name="ask_question" id="ask_question" required>{{ old('ask_question') }}</textarea>
