    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_confirm') ? 'is-invalid' : '' }}" type="email" name="email_confirm" id="email_confirm" value="{{ old('email_confirm') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('employee') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="employee" id="employee" value="1" {{ old('employee', 0) == 1 ? 'checked' : '' }}>
